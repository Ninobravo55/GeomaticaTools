...
"""
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        feedback.pushInfo("====================================================")
        feedback.pushInfo("              REPROYECTAR RASTER                    ")
        feedback.pushInfo("====================================================")
        ...
        if ds is None:
            raise QgsProcessingException('No se pudo abrir el raster de entrada con GDAL.')
        ...
        for i in range(1, num_bands + 1):
            ...
            feedback.pushInfo(f"  Banda {i}: {name if name else '(sin nombre)'}")
        ...
        if out_ds is None:
            raise QgsProcessingException('Fallo al reproyectar el raster mediante GDAL.')
