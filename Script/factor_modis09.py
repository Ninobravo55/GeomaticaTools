...
"""
    ...
    def initAlgorithm(self, config=None):
        self.addParameter(QgsProcessingParameterFile(
            self.INPUT_FOLDER,
            self.tr("Carpeta con archivos MODIS 09 HDF\n(MOD09GQ, MYD09GQ, MOD09GA, MOD09A1, ...)"),
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        feedback.pushInfo(f"📄 Archivos MODIS 09 encontrados: {len(hdfs_validos)}")
        feedback.pushInfo("")
        ...
        feedback.pushInfo("")
        feedback.pushInfo(f"{'='*60}")
        feedback.pushInfo(f"✅ MODIS 09 — {total_exportados} archivo(s) exportado(s) en total")
